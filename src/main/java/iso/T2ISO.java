...
void start() {
    ...
    flavourBox.addActionListener(_ -> {
        ...
        for (String line : items) {
            ...
            version = version.trim();            versionBox.addItem(version);
        }
    });
    ...
    gbc.gridx=0; gbc.gridy=0; panel.add(flavourLabel, gbc);
    gbc.gridx=1; panel.add(flavourBox, gbc);

    gbc.gridx=0; gbc.gridy=1; panel.add(versionLabel, gbc);
    gbc.gridx=1; panel.add(versionBox, gbc);

    gbc.gridx=0; gbc.gridy=2; gbc.gridwidth=2; panel.add(partLabel, gbc);
    gbc.gridy=3; panel.add(progressBar, gbc);
    gbc.gridy=4; panel.add(statusLabel, gbc);
    gbc.gridy=5; panel.add(downloadButton, gbc);
